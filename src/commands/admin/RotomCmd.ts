...
import { BotReturnCode } from '@root/src/constants.js';
...
const RotomCmd = {
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        switch (subCommand) {
            case 'restart':
                this.executeRestartStop(interaction, subCommand);
                break;
            case 'stop':
                this.executeRestartStop(interaction, subCommand);
                break;
            case 'deploy-commands':
                this.executeDeployCommands(interaction);
                break;
            case 'ping':
                this.executePing(interaction);
                break;
            default:
