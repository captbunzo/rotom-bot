...
const TeamRoleCmd = {
    ...
    async executeSet(interaction, subCommand) {
        ...
        const guildTeamRole = await GuildTeamRole.get({ guildId: guildId, team: team, unique: true });
    ...
    async executeClearAll(interaction) {
        const client = interaction.client;
        const guildId = interaction.guild.id;
