...
const BattleAlertCmd = {
	...
	data: new SlashCommandBuilder()
        ...
        .addSubcommand(subCommand => subCommand
            .setName('list')
            .setDescription('List all battle alerts')
        )
        .addSubcommand(subCommand => subCommand
            .setName('delete')
    ...
    async executeCreate(interaction) {
        ...
        let guildBattleAlert = await GuildBattleAlert.get(guildBattleAlertSearchObject);
    ...
    async executeDelete(interaction) {
        ...
        const guildBattleAlert = await GuildBattleAlert.get({ id: alertId, guildId: guildId, unique: true });
