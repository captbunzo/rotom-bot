...
export class BattleMember extends DrossDatabaseTable {
    ...
    get battleId(): Snowflake {
        return this.getField('battleId');
    }
    ...
    set battleId(value: Snowflake) {
        this.setField('battleId', value);
    }
    ...
    static override async get(
        conditions: BattleMemberConditions = {},
    ...
    override async update(
        condition: BattleMemberConditions = { battleId: this.battleId, discordId: this.discordId }
    ) {
