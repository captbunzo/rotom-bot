...
export class PokedexPokemon extends DrossDatabaseTable {
    ...
    get caught(): boolean {
        return this.getField('caught');
    }
    get shiny(): boolean {
        return this.getField('shiny');
    }
    get hundo(): boolean {
        return this.getField('hundo');
    }
    get lucky(): boolean {
        return this.getField('lucky');
    }
    get xxl(): boolean {
        return this.getField('xxl');
    }
    get xxs(): boolean {
        return this.getField('xxs');
    }
    get shadow(): boolean {
        return this.getField('shadow');
    }
    get purified(): boolean {
        return this.getField('purified');
    }
    ...
    set caught(value: boolean) {
        this.setField('caught', value);
    }
    set shiny(value: boolean) {
        this.setField('shiny', value);
    }
    set hundo(value: boolean) {
        this.setField('hundo', value);
    }
    set lucky(value: boolean) {
        this.setField('lucky', value);
    }
    set xxl(value: boolean) {
        this.setField('xxl', value);
    }
    set xxs(value: boolean) {
        this.setField('xxs', value);
    }
    set shadow(value: boolean) {
        this.setField('shadow', value);
    }
    set purified(value: boolean) {
        this.setField('purified', value);
    }
    ...
    static override async get(
        conditions: PokedexPokemonConditions = {},
    ...
    override async update(
        condition: PokedexPokemonConditions = {
    ...
    async buildEmbed(masterPokemon: MasterPokemon | null = null): Promise<EmbedBuilder> {
        ...
        if (!masterPokemonFound) {
            masterPokemonFound = await MasterPokemon.getUnique({
                pokedexId: this.pokedexId,
                form: this.form || null,
            });
            if (!masterPokemonFound) {
                throw new Error(
                    `Master Pokemon not found for Pokédex ID ${this.pokedexId} and form ${this.form}`
                );
            }
        }
        ...
        embed = embed.setTimestamp(this.updatedAt);
