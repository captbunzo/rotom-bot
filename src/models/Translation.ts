...
export default class Translation extends DrossDatabaseTable {
    ...
    get variantId (): number | null { return this.getField('variantId'); }
    get isPlural  (): boolean       { return this.getField('isPlural'); }
    get language  (): string        { return this.getField('language'); }
    get value     (): string        { return this.getField('value'); }
    get code      (): string        { return this.getField('code'); }
    ...
    static async getPokemonName(pokedexId: number, language = Translation.Language.English): Promise<string | null> {
    ...
    static async getPokemonDescription(pokedexId: number, language = Translation.Language.English): Promise<string | null> {
    ...
    static async getPokemonType(type: string, language = Translation.Language.English): Promise<string | null> {
