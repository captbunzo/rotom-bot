...
import { BattleStatus, BossType, MaxAutoCompleteChoices } from '@/constants.js';
...
const RaidCmd = {
    ...
    data: new SlashCommandBuilder()
        ...
        .addBooleanOption((option) =>
            option.setName('mega').setDescription('Mega Raid').setRequired(false)
        )
        .addBooleanOption((option) =>
            option.setName('shadow').setDescription('Shadow Raid').setRequired(false)
        ),
