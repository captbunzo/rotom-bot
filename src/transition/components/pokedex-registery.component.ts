...
export class PokedexRegisteryComponentClass
    implements ButtonsComponent, ModalComponent, SelectComponent
{
    name = 'PokedexRegisteryComponent';

    // ChatInputCommandInteraction
    async show(interaction: BaseInteraction, masterPokemon: MasterPokemon): Promise<void> {
    ...
    async handleModalSubmit(interaction: ModalSubmitInteraction): Promise<void> {
        ...
        void this.show(interaction, masterPokemon);
    }
}
